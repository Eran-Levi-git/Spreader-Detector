 ...
 * the initial size for the dynamic arrays the person owns (such as meetings).
 */
#define PERSON_INITIAL_SIZE 16UL

/**
 * @def PERSON_GROWTH_FACTOR
 * the growth factor in case of extending the dynamic arrays (such as meetings).
 * the person owns.
 */
...
typedef struct Person {
  ...
  int infection_rate_calculate_indicator;
  int spread_calculation;
} Person;
